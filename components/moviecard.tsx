...
const MovieCard: React.FC<MovieCardProps> = ({ data }) => {
  ...
  return (
    <div className="group bg-zinc-900 col-span relative h-[12vw]">
      <Image fill src={data.thumbnailUrl} alt="Movie" draggable={false} className="
        cursor-pointer
        object-cover
        transition
        duration
      ...
      ">
        <Image width={32} height={32}  onClick={redirectToWatch} src={data.thumbnailUrl} alt="Movie" draggable={false} className="
          cursor-pointer
          object-cover
          transition
          duration
        ...
        <div className="
          ...
          <div className="flex flex-row items-center gap-3">
            <div onClick={redirectToWatch} className="cursor-pointer w-6 h-6 lg:w-10 lg:h-10 bg-white rounded-full flex justify-center items-center transition hover:bg-neutral-300">
              <BsPlayBtnFill className="text-black w-4 lg:w-6" />
            </div>
